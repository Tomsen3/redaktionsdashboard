...
// Formatspezifische Schnellzugriff-Links (z. B. Canva-Vorlage, SharePoint-Ordner eines
// bestimmten Formats), verwaltet in FormatsAndRulesView. Anders als quick_links (feste,
// vorab angelegte Slugs) sind das frei anlegbare, an ein Format gebundene Links ohne Slug.
export function mapFormatQuickLink(row: any) {
  return {
    id: row.id,
    formatId: row.format_id,
    label: row.label,
